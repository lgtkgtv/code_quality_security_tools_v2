...
converted_numbers: List[Union[int, float]] = [int(x) for x in string_numbers]
...
if __name__ == "__main__":
    ...
    user_result = process_users(users)
    print(f"Result type: {type(user_result)}, value: {user_result}")
